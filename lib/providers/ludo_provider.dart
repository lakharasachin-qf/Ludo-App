...
import 'package:ludo_flutter/screens/ludo_player.dart';
import 'package:provider/provider.dart';

import '../utils/audio.dart';
import '../utils/ludo_colors.dart';
...
class LudoProvider extends ChangeNotifier {
  ...
  void resetGame() {
    _gameState = LudoGameState.throwDice; // reset state
    _currentTurn = LudoPlayerType.green; // reset turn
    _diceResult = 0;
    _diceStarted = false;
    _isMoving = false;
    _stopMoving = false;

    startGame(); // initialize players and clear winners
